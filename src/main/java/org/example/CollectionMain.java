...
public class CollectionMain {
  public static void main(String[] args) {
    ...
    stringList1.add("Umesh");
    stringList1.add("Krishna");
...
//    synchronize ArrayList 1. Collection.synchronizedList() - Method - return synchronized list
    ...
    synchronizedStringList.add("JAI");
    synchronizedStringList.add("Karan");
    synchronizedStringList.add("JAI");
    synchronizedStringList.add("Amit");
...
//    synchronize ArrayList 2. copyOnWriteArrayList - class - Thread Safe variant of ArrayList
    ...
    stringCopyOnWriteArrayList.add("Tom");
    stringCopyOnWriteArrayList.add("Steve");
    stringCopyOnWriteArrayList.add("Naveen");

    // no need to explicit synchronization for any operation: add/remove/traverse
    Iterator<String> iterator2 = stringCopyOnWriteArrayList.iterator();
